...
public class HW2
{
   ...
   /// <summary>
   ///    Калькулятор. С консоли вводится левый операнд, операция, 
   ///    правый операнд.Выводится результат операции над операндами.
   ///    Реализовать как минимум 3 операции, обработку ошибок (деление на 0 и др).
   /// </summary>
   public static void Task3_Calculator()
   {
       ...
       {
           Console.WriteLine("Wow! It's something new. I don't know this operation"); 
       }
   }
}